...
const standardStarter = (track, order, title) => {
  if (track === 'react') {
    return reactProjectFor(order, 'guided', 'starter');
  }
...
const definitions = [
  {
    ...
    focus: 'trzy warstwy strony i nazwy plików', file: 'index.html', token: '<main',
  ...
  },
  {
    ...
    focus: 'doctype, html, head, body, lang, meta i title', file: 'index.html', token: '<!doctype html',
  ...
  },
  {
    ...
    focus: 'h1–h6, p, strong, em, br, hr, sup i sub', file: 'index.html', token: '<h1',
  ...
  },
  {
    ...
    focus: 'ul, ol, li, dl, dt, dd i poprawne zagnieżdżanie', file: 'index.html', token: '<ul',
  ...
  },
  {
    ...
    focus: 'a, href, ścieżki, fragmenty, nav, target i rel', file: 'index.html', token: 'href=',
  ...
  },
  {
    ...
    focus: 'img, alt, figure, figcaption, audio, video i source', file: 'index.html', token: 'alt=',
  ...
  },
  {
    ...
    focus: 'table, caption, thead, tbody, th, td i scope', file: 'index.html', token: '<table',
  ...
  },
  {
    ...
    focus: 'form, label, input, select, textarea, button i required', file: 'index.html', token: '<label',
  ...
  },
  {
    ...
    focus: 'semantyczne landmarks, focus, kontrast i natywne kontrolki', file: 'index.html', token: '<main',
  ...
  },
  {
    ...
    focus: 'link, selektor, właściwość, wartość i komentarz CSS', file: 'styles.css', token: 'color:',
    objectives: ['Rozdziel strukturę HTML od wyglądu CSS.', 'Rozumiej, który arkusz wygrywa w kaskadzie.'],
    theory: ['Reguła CSS łączy selektor z deklaracjami właściwości i wartości.', 'Arkusz `styles.css` zawiera fundamenty i reguły wizualne strony; kolejność zapisanych w nim reguł wpływa na kaskadę.'],
  },
  {
    order: 11, id: 'css-selectors', track: 'css', title: 'Selektory i kaskada',
    summary: 'Wybieraj elementy i przewiduj wynik kaskady.',
    focus: 'element, class, id, atrybuty, potomkowie i pseudoklasy', file: 'styles.css', token: '.',
  ...
  },
  {
    ...
    focus: 'rem, %, vw, font-size, line-height, text-align i zmienne CSS', file: 'styles.css', token: '--',
  ...
  },
  {
    ...
    focus: 'content, padding, border, margin, width, height i box-sizing', file: 'styles.css', token: 'box-sizing',
  ...
  },
  {
    ...
    focus: 'display, position, z-index, background, border-radius i overflow', file: 'styles.css', token: 'display:',
  ...
  ...layoutTopics,
  {
    ...
    focus: 'transition, hover, focus, keyframes i prefers-reduced-motion', file: 'styles.css', token: 'transition:',
  ...
  },
  {
    ...
    focus: 'script, console, const, let i podstawowe typy', file: 'script.js', token: 'const',
  ...
  },
  {
    ...
    focus: 'if, else, operatory, parametry i return', file: 'script.js', token: 'function',
  ...
  },
  {
    ...
    focus: 'tablice, obiekty, for, for...of, map i filter', file: 'script.js', token: '.map(',
  ...
  },
  {
    ...
    focus: 'querySelector, textContent, classList i tworzenie elementów', file: 'script.js', token: 'querySelector',
  ...
  },
  {
    ...
    focus: 'addEventListener, click, input, submit i preventDefault', file: 'script.js', token: 'addEventListener',
  ...
  },
  {
    ...
    focus: 'obiekt stanu, render, filtrowanie listy i empty state', file: 'script.js', token: 'render',
  ...
  },
  {
    ...
    focus: 'try/catch, JSON.stringify, JSON.parse i localStorage', file: 'script.js', token: 'localStorage',
  ...
  },
  {
    ...
    summary: 'Połącz semantyczny HTML, arkusz styles.css, formularz i interakcje.',
    focus: 'formularz wydarzenia, tabela zadań, responsywność i checklista jakości', file: 'script.js', token: 'addEventListener',
  ...
  },
  {
    ...
    focus: 'React, JSX, createRoot i renderowanie', file: 'main.jsx', token: 'createRoot',
    objectives: ['Wyrenderuj komponent do elementu root.', 'Zapisuj atrybuty JSX zgodnie z regułami Reacta.'],
    theory: ['JSX jest składnią opisującą drzewo elementów, które React zamienia na DOM.', 'W tym sandboxie importujesz `react` oraz `react-dom/client` w modułach, a main.jsx montuje eksportowany komponent App.'],
  },
  {
    ...
    focus: 'komponenty funkcyjne, props, children i kompozycja', file: 'components/Card.jsx', token: 'children',
  ...
  },
  {
    ...
    focus: 'useState, onClick, formularze i ponowne renderowanie', file: 'App.jsx', token: 'useState',
  ...
  },
  {
    ...
    focus: 'map, key, filtrowanie i operator warunkowy', file: 'App.jsx', token: '.map(',
  ...
  },
  {
    ...
    focus: 'value, onChange, onSubmit, walidacja i reset', file: 'App.jsx', token: 'onChange',
  ...
  },
  {
    ...
    focus: 'useEffect, zależności, cleanup i unikanie pętli renderowania', file: 'App.jsx', token: 'useEffect',
  ...
  },
  {
    ...
    focus: 'lifting state up, callbacki, children i custom hook', file: 'hooks/useCounter.js', token: 'useCounter',
  ...
  },
  {
    ...
    focus: 'komponenty, stan, formularz, filtrowanie, RWD i prosty zapis', file: 'components/TaskItem.jsx', token: 'TaskItem',
